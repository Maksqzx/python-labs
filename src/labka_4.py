class Zoo:
    def __init__(self, vs_number = 0, name = None, an_number = 0, year = 0, type_of_animal = None):
    ...
    def __str__(self):
        ...
        return (f"кількість відвідувачів: {self.__vs_number}, "
                f"Назва '{self.__name}', "
    ...
    def __repr__(self):
        ...
        return (f"vs_number={self.__vs_number}, "
                f"name='{self.__name}', "
